...
<?php get_header();?>
    ...
    <div id="home-comes-bebes">
        <div id="home-comes-bebes-content">
            <h1 id="home-comes-bebes-titulo">Comes&Bebes</h1>
            <p id="home-comes-bebes-text">O restaurante para todas as fomes</p>
        </div>
    </div>
    ...
    <div id="all-visite-loja">
        <div id="visite-loja">
            ...
            <div id="all-content-loja">
                ...
                <div>
                    <img class="foto-pessoas" src="<?php echo get_stylesheet_directory_uri()?>/assets/img-pessoas.png">
                </div>
            </div>
